...
final class AlarmManager {
    ...
    static func willShowAlarm(forDogName dogName: String, forDogId dogId: Int, forReminder: Reminder) {
        ...
        RemindersRequest.get(invokeErrorManager: false, forDogId: dogId, forReminder: forReminder) { reminder, responseStatus, _ in
    ...
    private static func willLogAlarm(forDogId dogId: Int, forReminder reminder: Reminder, forLogAction logAction: LogAction) {
        ...
        if reminder.reminderType == .oneTime {
            ...
            RemindersRequest.delete(invokeErrorManager: true, forDogId: dogId, forReminder: reminder) { requestWasSuccessful, _, _ in
                ...
                LogsRequest.create(invokeErrorManager: true, forDogId: dogId, forLog: log) { logId, _, _ in
