...
extension Notification.Name {
    ...
    // TODO TIME make views that use Calendar.user or UserConfiguration.user watch this notification and recalc/reload times when the user time zone changes. However, be careful that this doesn't create an infinite ref, make sure the refs deallocate themselves, similar with weak delegates
