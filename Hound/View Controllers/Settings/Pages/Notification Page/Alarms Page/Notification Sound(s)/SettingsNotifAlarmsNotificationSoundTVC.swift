...
final class SettingsNotifsAlarmsNotificationSoundTVC: HoundTableViewCell {
    ...
    func setCustomSelectedTableViewCell(_ selected: Bool, animated: Bool) {
        ...
        UIView.animate(withDuration: animated ? VisualConstant.AnimationConstant.selectUIElement : 0.0) {
    ...
    override func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            notificationSoundLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -ConstraintConstant.Spacing.absoluteVerticalInset)
        ])
    }
