...
final class SettingsNotifsAlarmsTVC: GeneralUITableViewCell {
    ...
    override func setupConstraints() {
        ...
        let chevonImageViewTrailing = chevonImageView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -ConstraintConstant.Global.contentInset)
