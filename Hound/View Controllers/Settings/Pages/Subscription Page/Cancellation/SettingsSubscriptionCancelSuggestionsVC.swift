...
final class SettingsSubscriptionCancelSuggestionsViewController: GeneralUIViewController, UITextViewDelegate {
    ...
    @IBAction private func didTapContinue(_ sender: Any) {
        ...
        SurveyFeedbackRequest.create(invokeErrorManager: false, userCancellationReason: cancellationReason, userCancellationFeedback: suggestionTextView.text ?? "") { _, _ in
            return
        }
